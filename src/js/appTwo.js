...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function searchRecipes(event) {
    ...
    const searchQuery = 'random.php'
    // console.log(searchQuery); // document.getElementById("search-bar").value.trim();
    ...
    try {
      const res = await fetch(
        `https://www.themealdb.com/api/json/v1/1/${searchQuery}`
      );
        ...
        try {
          ...
          modalContent += `
            <div class="relative rounded-lg bg-gray-700 max-w-4xl mx-auto">
              ...
              >
                <h3
                  class=" font-medium capitalize text-white"
              ...
              <div class="space-y-6 p-6">
                <div class="flex flex-wrap items-center justify-between gap-4">
                  <h3 class="text-white">Recipe Preparation:</h3>
              ...
              >
                <h3 class="text-center text-white">Recipe Tutorial Video</h3>
        ...
        >
          ...
          <div class="p-5">
            ...
            <div class="flex w-full items-center justify-center">
              <button
                class="recipe-btn mt-4 inline-flex items-center rounded-lg bg-teal-600 px-3 py-2 text-center text-white text-sm font-medium text-slate-900 transition duration-300 ease-in-out hover:bg-teal-700 focus:outline-none focus:ring-4 focus:ring-bg-blue-700"
                id="recipe-btn"
                data-id="${meal.idMeal}"
                type="button"
              >
